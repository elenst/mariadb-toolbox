...
################################################################################
query:
	{ @nonaggregates = () ; $tables = 0 ; $fields = 0 ; $subquery_idx=0 ; $child_subquery_idx=0 ; "" } FLUSH STATUS; main_select ;
...
limit:
        | limit_rows_examined | limit_rows_examined | limit_rows_examined | 
        LIMIT limit_size | LIMIT limit_size OFFSET _digit | 
        limit_rows_examined OFFSET _digit;

limit_rows_examined:
        LIMIT limit_size ROWS EXAMINED _smallint_unsigned |
