$combinations = [
    ...
    [
		...
		'--grammar=conf/mariadb/optimizer.yy --skip-gendata --mysqld=--init-file='.getcwd().'/conf/mariadb/world.sql',
		...
		'--grammar=conf/optimizer/optimizer_access_exp.yy --skip-gendata --mysqld=--init-file='.getcwd().'/conf/mariadb/world.sql',
    ]
];
