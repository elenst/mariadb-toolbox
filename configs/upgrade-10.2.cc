...
# 32K and 64K only applicable to 10.1+ and MySQL 5.7
    [
        ...
        '--basedir1=/data/bld/10.1 --mysqld=--loose-innodb-page-size=16K',
        '--basedir1=/data/bld/10.1 --mysqld=--loose-innodb-page-size=8K',
        '--basedir1=/data/bld/10.1 --mysqld=--loose-innodb-page-size=4K',
        '--basedir1=/data/bld/10.1 --mysqld=--loose-innodb-page-size=32K',
        '--basedir1=/data/bld/10.1 --mysqld=--loose-innodb-page-size=64K',

        '--basedir1=/data/bld/10.1 --mysqld1=--ignore-builtin-innodb --mysqld1=--plugin-load-add=ha_innodb --mysqld=--loose-innodb-page-size=16K',
        '--basedir1=/data/bld/10.1 --mysqld1=--ignore-builtin-innodb --mysqld1=--plugin-load-add=ha_innodb --mysqld=--loose-innodb-page-size=8K',
        '--basedir1=/data/bld/10.1 --mysqld1=--ignore-builtin-innodb --mysqld1=--plugin-load-add=ha_innodb --mysqld=--loose-innodb-page-size=4K',
        '--basedir1=/data/bld/10.1 --mysqld1=--ignore-builtin-innodb --mysqld1=--plugin-load-add=ha_innodb --mysqld=--loose-innodb-page-size=32K',
        '--basedir1=/data/bld/10.1 --mysqld1=--ignore-builtin-innodb --mysqld1=--plugin-load-add=ha_innodb --mysqld=--loose-innodb-page-size=64K',
        ...
        '--basedir1=/data/bld/mysql-5.7 --mysqld=--loose-innodb-page-size=16K',
        '--basedir1=/data/bld/mysql-5.7 --mysqld=--loose-innodb-page-size=8K',
        '--basedir1=/data/bld/mysql-5.7 --mysqld=--loose-innodb-page-size=4K',
        '--basedir1=/data/bld/mysql-5.7 --mysqld=--loose-innodb-page-size=32K',
        '--basedir1=/data/bld/mysql-5.7 --mysqld=--loose-innodb-page-size=64K',

        '--basedir1=/data/bld/5.5 --mysqld=--loose-innodb-page-size=16K',
        '--basedir1=/data/bld/5.5 --mysqld=--loose-innodb-page-size=8K',
        '--basedir1=/data/bld/5.5 --mysqld=--loose-innodb-page-size=4K',
        
        '--basedir1=/data/bld/5.5 --mysqld1=--ignore-builtin-innodb --mysqld1=--plugin-load=ha_innodb',
    ],
]
