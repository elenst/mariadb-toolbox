...
$combinations = [
	...
	'
		...
		--redefine=/home/elenst/mariadb-toolbox/grammars/mdev-452-redefine.yy
	'], 
	# Cannot use the extra grammar with virtual columns due to bug MDEV-3938
	#	--redefine=/home/elenst/mariadb-toolbox/grammars/mdev-452-redefine-extra.yy
	[
		...
		'--views --grammar=conf/optimizer/optimizer_no_subquery.yy',
		'--views --grammar=conf/optimizer/optimizer_subquery.yy',
	],
	[
		'--engine=InnoDB',
		'--engine=MyISAM',
...
# 1317: Query partially completed on the master
...
# 1505: MySQL:64041 (Partition management on a not partitioned table) 
	[
		...
		'--rpl_mode=statement --mysqld=--slave-skip-errors=1054,1317,1049,1305,1539,1505 --redefine=/home/elenst/mariadb-toolbox/grammars/mdev-452-workarounds-sbr.yy',
	],
];
